    ...
    <View style={styles.container}>
      <View>
        ...
        <Text style={styles.subTitleText}>
          To best experience the SEEUS app, allow location services
        </Text>
        <Button
        ...
        <Text style={styles.furtherDescriptionText}>
          Your location is used to display the campus map and nearby locations,
          and shared with the SEEUS dispatcher only when you submit a request.
        </Text>
      </View>
      <Button
        label="Skip"
